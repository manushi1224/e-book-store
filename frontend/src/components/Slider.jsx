...
export default function Slider(props) {
    ...
    const saveWishlist = async (bookId) => {
        ...
        try {
            const response = await axios.post('https://manushi1224.pythonanywhere.com/create_api/wishlist/', wishlist)
    ...
    const deleteWishlist = async (bookId) =>{
        ...
        try {
            const response = await axios.post('https://manushi1224.pythonanywhere.com/create_api/deletewishlist/', wishlist)
